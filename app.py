...
st.markdown("---") # एक आडवी ओळ ओढण्यासाठी
st.header("📍 Disease Mapping (नकाशावर रोगाची नोंद)")
st.write("M.Sc. Geoinformatics: ड्रोनद्वारे मिळालेल्या डेटाचे नकाशावर सादरीकरण")

# तुमच्या गावाचे किंवा कॉलेजचे को-ऑर्डिनेट्स इथे टाका
# उदा. [latitude, longitude]
m = folium.Map(location=[18.5204, 73.8567], zoom_start=15) 

# रोगाचे ठिकाण मार्क करण्यासाठी मार्कर
folium.Marker(
    [18.5204, 73.8567], 
    popup="Red Rot Detected", 
